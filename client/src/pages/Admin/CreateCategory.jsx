                                    ...
                                    {categories?.map((c) => (
                                        <>
                                            <tr>
                                                ...
                                                <td>
                                                    <button className='btn btn-primary px-4 ms-2 ' onClick={() => { setVisible(true); setUpdatedName(c.name); setSelected(c) }}>Edit</button>
                                                    <button className='btn btn-danger px-4 ms-2' onClick={() => { handleDelete(c._id) }}>Delete</button>
                                                </td>
                                            </tr>
                                        </>
                                    ))}
