            ...
            <div className="row container mt-3 ms-3">
                <div className="col-md-5">
                    ...
                    <img
                        ...
                        alt=""
                        className="card-img-top mt-2 rounded-3"
                        style={{ width: "400px", height: "400px" }}
                    />
                </div>
                <div className="col-md-6">
                    <h4 className="text-center"> Product Details</h4>
                    <h6 className="mt-5">Name : {product.name}</h6>
                    <h6 className="mt-2">Description : {product.description}</h6>
            ...
            <div className="row container similar-products">
                ...
                <div className="d-flex flex-wrap">
                    {relatedProducts?.map((p) => (
                        <div className="card m-2" key={p._id} style={{ width: "18rem", borderRadius: "5px" }}>
                            <img
